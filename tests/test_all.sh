...
#"crypto_aead_hash/isapa128av20/bi_32_armv6m"         # works only on arm devices
#"crypto_aead_hash/isapa128av20/bi_32_armv6m_compact" # works only on arm devices
#"crypto_aead_hash/isapa128av20/bi_32_armv6m_stp"     # works only on arm devices
#"crypto_aead_hash/isapa128av20/bi_32_armv7m"         # works only on arm devices
